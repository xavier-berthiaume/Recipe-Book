...
class QRecipeIngredient : public Storable {
  ...
  Q_PROPERTY(QIngredient *m_ingredient READ getIngredient WRITE setIngredient
                 NOTIFY ingredientChanged)
  Q_PROPERTY(QString m_quantity READ getQuantity WRITE setQuantity NOTIFY
                 quantityChanged)
  Q_PROPERTY(QString m_unit READ getUnit WRITE setUnit NOTIFY unitChanged)
  Q_PROPERTY(
      bool m_isRecipe READ getIsRecipe WRITE setIsRecipe NOTIFY isRecipeChanged)
