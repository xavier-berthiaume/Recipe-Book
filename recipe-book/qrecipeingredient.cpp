...
QRecipeIngredient::QRecipeIngredient(QIngredient *ingredient,
                                     ...
                                     QObject *parent)
    : Storable(parent), m_ingredient(ingredient), m_quantity(quantity) {
  setUnit(unit);
}

QIngredient *QRecipeIngredient::getIngredient() const { return m_ingredient; }

QString QRecipeIngredient::getQuantity() const { return m_quantity; }

QString QRecipeIngredient::getUnit() const { return m_unit; }

bool QRecipeIngredient::getIsRecipe() const { return m_isRecipe; }

void QRecipeIngredient::setIngredient(QIngredient *ingredient) {
  if (ingredient == m_ingredient)
    return;
