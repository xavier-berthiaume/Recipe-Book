...
QIngredient::QIngredient(QObject *parent)
    : Storable{parent}
{}

QIngredient::QIngredient(QUuid id, QObject *parent)
    : Storable(id, parent)
{}

QIngredient::QIngredient(const QString &name, const QString &description, QObject *parent)
    : Storable(parent)
...
QProfile *QIngredient::getCreator() const {
    return m_creator;
}
